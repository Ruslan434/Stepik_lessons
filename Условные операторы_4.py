...
if 2 <= n <= 27 and m == 2:
    ...
    print(str(12).rjust(2, '0') + "." + str(31).rjust(2, "0"), str(m).rjust(2, '0') + "." + str(n + 1).rjust(2, "0"),
          sep=' ')
elif n == 31 and m == 12:
    print(str(m).rjust(2, '0') + "." + str(n - 1).rjust(2, "0"), str(1).rjust(2, '0') + "." + str(1).rjust(2, "0"),
          sep=' ')
    ...
    print(str(m - 1).rjust(2, '0') + "." + str(30).rjust(2, "0"), str(m).rjust(2, '0') + "." + str(n + 1).rjust(2, "0"),
          sep=' ')

elif n == 1 and m == 3:
    print(str(m - 1).rjust(2, '0') + "." + str(28).rjust(2, "0"), str(m).rjust(2, '0') + "." + str(n + 1).rjust(2, "0"),
          sep=' ')
elif n == 28 and m == 2:
