...
# С помощью list comprehension сформировать список lst, содержащий
# цифры этого числа (в списке должны быть записаны числа, а не строки).
# Результат вывести на экран список командой:
#print(lst)
d = input("Введи число, например 4567397   ")
c = [int(f) for f in d]
print(c)